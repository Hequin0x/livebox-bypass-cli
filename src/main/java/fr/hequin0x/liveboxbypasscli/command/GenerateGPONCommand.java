...
@Command(
        name = "generate-gpon",
        description = "Generate the necessary GPON configuration to bypass Orange Livebox."
)
public final class GenerateGPONCommand extends AuthenticatedCommand implements Runnable {

    private static final Logger LOG = Logger.getLogger(GenerateGPONCommand.class);

    public GenerateGPONCommand(@RestClient final LiveboxService liveboxService, final LiveboxAuthSession liveboxAuthSession) {
